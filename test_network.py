...
from network_service import CommandResult, NetworkError, apply_network_settings, get_network_state
...
class NetworkServiceTests(unittest.TestCase):
    def test_reads_current_dhcp_configuration(self):
        ...
        self.assertEqual(current["interfaces"][0]["dns"], ["1.1.1.1", "8.8.8.8"])
    ...
    def test_rejects_gateway_outside_subnet(self):
        with self.assertRaisesRegex(NetworkError, "same subnet"):
